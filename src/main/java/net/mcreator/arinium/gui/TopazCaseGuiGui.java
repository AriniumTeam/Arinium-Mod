...
public class TopazCaseGuiGui extends AriniumModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TopazCaseGuiGui(AriniumModElements instance) {
		super(instance, 156);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("topaz_case_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, TopazCaseGuiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(75, this.addSlot(new SlotItemHandler(internal, 75, 276, 78) {
			}));
			this.customSlots.put(76, this.addSlot(new SlotItemHandler(internal, 76, 240, 6) {
			}));
			this.customSlots.put(77, this.addSlot(new SlotItemHandler(internal, 77, 240, 24) {
			}));
			this.customSlots.put(78, this.addSlot(new SlotItemHandler(internal, 78, 240, 42) {
			}));
			this.customSlots.put(79, this.addSlot(new SlotItemHandler(internal, 79, 240, 60) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
