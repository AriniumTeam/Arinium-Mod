...
import net.mcreator.arinium.block.WeirdStoneBlock;
import net.mcreator.arinium.block.WeirdGrassBlockBlock;
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(WeirdGrassBlockBlock.block.getDefaultState(),
								WeirdStoneBlock.block.getDefaultState(), WeirdStoneBlock.block.getDefaultState())));
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.SNOW).category(Biome.Category.NONE).depth(10f).scale(2f).temperature(-1f)
						.downfall(1f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("arinium:weird_biome"));
			}
		}
	}
	@Override
