...
import net.mcreator.arinium.gui.BlueEndermenProcedureGui;
import net.mcreator.arinium.entity.renderer.BlueEndermanRenderer;
...
public class BlueEndermanEntity extends AriniumModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777012, new Item.Properties().group(UtilitiesItemGroup.tab))
				.setRegistryName("blue_enderman_spawn_egg"));
	}
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Blue Enderman");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BlueEndermenProcedureGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
