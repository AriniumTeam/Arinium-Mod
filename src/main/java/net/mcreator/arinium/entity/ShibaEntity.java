...
import net.mcreator.arinium.entity.renderer.ShibaRenderer;
...
public class ShibaEntity extends AriniumModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 0.3, (float) 10, (float) 2, false));
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(DarkSkeletonBoneItem.block, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
	}
