...
import net.mcreator.arinium.item.RedPearlItem;
import net.mcreator.arinium.entity.renderer.RedEndermanRenderer;
...
public class RedEndermanEntity extends AriniumModElements.ModElement {
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RedPearlItem.block, (int) (1)));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.death"));
		}
