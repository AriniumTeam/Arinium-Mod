...
import net.mcreator.arinium.item.HumanMeatItem;
import net.mcreator.arinium.entity.renderer.WeirdVillagerRenderer;
...
public class WeirdVillagerEntity extends AriniumModElements.ModElement {
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(HumanMeatItem.block, (int) (1)));
		}
