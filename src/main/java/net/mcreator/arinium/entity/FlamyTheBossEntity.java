...
import net.mcreator.arinium.procedures.FlamyTheBossProcedureProcedure;
import net.mcreator.arinium.itemgroup.UtilitiesItemGroup;
import net.mcreator.arinium.entity.renderer.FlamyTheBossRenderer;
...
public class FlamyTheBossEntity extends AriniumModElements.ModElement {
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_KNOCKBACK, 0.9);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new RandomWalkingGoal(this, 0.25));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				FlamyTheBossProcedureProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
