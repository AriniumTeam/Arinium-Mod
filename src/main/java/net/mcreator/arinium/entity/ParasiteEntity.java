...
import net.mcreator.arinium.procedures.ParasiteQuandLentiteMeurtProcedure;
import net.mcreator.arinium.itemgroup.UtilitiesItemGroup;
import net.mcreator.arinium.entity.renderer.ParasiteRenderer;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ParasiteQuandLentiteMeurtProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
