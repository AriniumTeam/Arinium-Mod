...
public class CrackedDarkBrickBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:cracked_dark_brick")
	public static final Block block = null;
	public CrackedDarkBrickBlock(AriniumModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cracked_dark_brick");
		}
