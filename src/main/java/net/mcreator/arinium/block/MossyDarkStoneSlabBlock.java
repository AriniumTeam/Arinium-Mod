...
public class MossyDarkStoneSlabBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:mossy_dark_stone_slab")
	public static final Block block = null;
	public MossyDarkStoneSlabBlock(AriniumModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_dark_stone_slab");
		}
