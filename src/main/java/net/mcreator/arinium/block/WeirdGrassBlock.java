...
public class WeirdGrassBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:weird_grass")
	public static final Block block = null;
	public WeirdGrassBlock(AriniumModElements instance) {
		super(instance, 82);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("arinium:weird_grass"), configuredFeature);
		}
	}
	@SubscribeEvent
