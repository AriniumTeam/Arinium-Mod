...
public class DarkBloodyBrickDoorBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:dark_bloody_brick_door")
	public static final Block block = null;
	public DarkBloodyBrickDoorBlock(AriniumModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_bloody_brick_door");
		}
