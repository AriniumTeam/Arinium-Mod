...
public class PinkBlockBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:pink_block")
	public static final Block block = null;
	public PinkBlockBlock(AriniumModElements instance) {
		super(instance, 124);
	}
