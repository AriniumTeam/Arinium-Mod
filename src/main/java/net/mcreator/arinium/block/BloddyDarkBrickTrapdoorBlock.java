...
public class BloddyDarkBrickTrapdoorBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:bloddy_dark_brick_trapdoor")
	public static final Block block = null;
	public BloddyDarkBrickTrapdoorBlock(AriniumModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bloddy_dark_brick_trapdoor");
		}
