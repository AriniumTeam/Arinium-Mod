...
import net.mcreator.arinium.item.CornItem;
...
public class CornPLantBlock extends AriniumModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("corn_p_lant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("arinium:corn_p_lant"), configuredFeature);
		}
	}
	@SubscribeEvent
