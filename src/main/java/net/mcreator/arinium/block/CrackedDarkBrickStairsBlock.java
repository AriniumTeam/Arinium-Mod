...
public class CrackedDarkBrickStairsBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:cracked_dark_brick_stairs")
	public static final Block block = null;
	public CrackedDarkBrickStairsBlock(AriniumModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_dark_brick_stairs");
		}
