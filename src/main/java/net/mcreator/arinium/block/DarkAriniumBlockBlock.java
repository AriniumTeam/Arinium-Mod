...
public class DarkAriniumBlockBlock extends AriniumModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(3f, 15f).setLightLevel(s -> 0));
			setRegistryName("dark_arinium_block");
		}
