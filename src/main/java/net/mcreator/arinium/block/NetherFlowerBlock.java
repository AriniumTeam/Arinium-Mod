...
public class NetherFlowerBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:nether_flower")
	public static final Block block = null;
	public NetherFlowerBlock(AriniumModElements instance) {
		super(instance, 102);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("nether_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("arinium:nether_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("arinium:nether_biome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
