...
public class AriniumLeavesBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:arinium_leaves")
	public static final Block block = null;
	public AriniumLeavesBlock(AriniumModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("arinium_leaves");
		}
