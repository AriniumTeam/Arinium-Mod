...
public class AriniumPlanksBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:arinium_planks")
	public static final Block block = null;
	public AriniumPlanksBlock(AriniumModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("arinium_planks");
		}
