...
public class AriniumLogBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:arinium_log")
	public static final Block block = null;
	public AriniumLogBlock(AriniumModElements instance) {
		super(instance, 10);
	}
