...
public class MossyDarkStoneStairsBlock extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:mossy_dark_stone_stairs")
	public static final Block block = null;
	public MossyDarkStoneStairsBlock(AriniumModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mossy_dark_stone_stairs");
		}
