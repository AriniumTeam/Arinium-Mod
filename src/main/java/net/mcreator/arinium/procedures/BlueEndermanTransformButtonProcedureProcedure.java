...
import net.mcreator.arinium.item.BluePearlItem;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				AriniumMod.LOGGER.warn("Failed to load dependency entity for procedure BlueEndermanTransformButtonProcedure!");
			return;
		}
		...
		if (((new Object() {
		...
		}.getItemStack((int) (0))).getItem() == new ItemStack(BloodBottleItem.block, (int) (1)).getItem())) {
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(BluePearlItem.block, (int) (1));
