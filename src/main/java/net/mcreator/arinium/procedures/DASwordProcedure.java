...
public class DASwordProcedure extends AriniumModElements.ModElement {
	public DASwordProcedure(AriniumModElements instance) {
		super(instance, 350);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				AriniumMod.LOGGER.warn("Failed to load dependency entity for procedure DASword!");
			return;
		}
