...
public class PlagueAspectEnchantment extends AriniumModElements.ModElement {
	...
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("plague_aspect"));
	}
