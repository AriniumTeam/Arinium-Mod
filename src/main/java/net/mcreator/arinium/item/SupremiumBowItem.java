...
import net.mcreator.arinium.entity.renderer.SupremiumBowRenderer;
import net.mcreator.arinium.AriniumModElements;

import java.util.Random;

@AriniumModElements.ModElement.Tag
public class SupremiumBowItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:supremium_bow")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(UtilitiesItemGroup.tab).maxDamage(10000));
			setRegistryName("supremium_bow");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(AriniumArrowNEItem.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(AriniumArrowNEItem.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(AriniumArrowNEItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected ItemStack getArrowStack() {
			return new ItemStack(AriniumArrowNEItem.block, (int) (1));
		}
