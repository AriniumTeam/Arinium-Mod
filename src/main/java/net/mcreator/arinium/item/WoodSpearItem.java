...
import net.mcreator.arinium.entity.renderer.WoodSpearRenderer;
...
public class WoodSpearItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:wood_spear")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(UtilitiesItemGroup.tab).maxDamage(50));
			setRegistryName("wood_spear");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(WoodenBulletSpearItem.block, (int) (1));
		}
