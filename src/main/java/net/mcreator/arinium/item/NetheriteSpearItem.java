...
import net.mcreator.arinium.entity.renderer.NetheriteSpearRenderer;
...
public class NetheriteSpearItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:netherite_spear")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(UtilitiesItemGroup.tab).maxDamage(1000));
			setRegistryName("netherite_spear");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 10, 3);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(NetheriteSpearBulletItem.block, (int) (1));
		}
