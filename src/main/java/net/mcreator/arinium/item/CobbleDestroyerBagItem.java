...
import net.mcreator.arinium.gui.DestroyerBagGUIGuiWindow;
import net.mcreator.arinium.gui.DestroyerBagGUIGui;
...
public class CobbleDestroyerBagItem extends AriniumModElements.ModElement {
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof DestroyerBagGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(UtilitiesItemGroup.tab).maxStackSize(1).rarity(Rarity.UNCOMMON));
			setRegistryName("cobble_destroyer_bag");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Cobble Destroyer Bag");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new DestroyerBagGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
