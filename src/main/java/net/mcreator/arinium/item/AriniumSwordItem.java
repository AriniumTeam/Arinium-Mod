...
public class AriniumSwordItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:arinium_sword")
	public static final Item block = null;
	public AriniumSwordItem(AriniumModElements instance) {
		super(instance, 4);
	}
