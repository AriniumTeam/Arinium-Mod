...
import net.mcreator.arinium.entity.renderer.StoneSpearRenderer;
...
public class StoneSpearItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:stone_spear")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(StoneSpearBulletItem.block, (int) (1));
		}
