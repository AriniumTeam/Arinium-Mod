...
import net.mcreator.arinium.entity.renderer.DiamondSpearRenderer;
...
public class DiamondSpearItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:diamond_spear")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(UtilitiesItemGroup.tab).maxDamage(500));
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 7, 2);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(DiamondSpearBulletItem.block, (int) (1));
		}
