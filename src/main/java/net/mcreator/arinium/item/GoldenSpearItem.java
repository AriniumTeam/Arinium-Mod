...
import net.mcreator.arinium.entity.renderer.GoldenSpearRenderer;
...
public class GoldenSpearItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:golden_spear")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(UtilitiesItemGroup.tab).maxDamage(100));
			setRegistryName("golden_spear");
		}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Ranged item modifier", (double) 5.5, AttributeModifier.Operation.ADDITION));
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 7.5, 2);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(GoldSpearBulletItem.block, (int) (1));
		}
