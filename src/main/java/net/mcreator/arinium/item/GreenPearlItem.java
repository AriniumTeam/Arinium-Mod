...
public class GreenPearlItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:green_pearl")
	public static final Item block = null;
	public GreenPearlItem(AriniumModElements instance) {
		super(instance, 80);
	}
