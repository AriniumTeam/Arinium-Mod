...
public class AriniumdustItem extends AriniumModElements.ModElement {
	@ObjectHolder("arinium:ariniumdust")
	public static final Item block = null;
	public AriniumdustItem(AriniumModElements instance) {
		super(instance, 1);
	}
