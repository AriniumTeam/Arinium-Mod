...
package net.mcreator.arinium.particle;
...
public class DarkAriniumParticleParticle extends AriniumModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public DarkAriniumParticleParticle(AriniumModElements instance) {
		super(instance, 345);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("dark_arinium_particle"));
	}
